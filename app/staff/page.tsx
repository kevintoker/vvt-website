  ...
  return (
    ...
    <main className="min-h-screen flex flex-col items-center overflow-y-hidden">
      <div className="flex-1 w-full flex flex-col gap-20 items-center">
        ...
        <footer className="w-full flex flex-col items-center justify-center border-t mx-auto text-center gap-4 py-8 mb-12">
          ...
          <p className="text-muted-foreground text-xs !text-black">Developed and maintained by{' '} <a
